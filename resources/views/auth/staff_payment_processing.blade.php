        ...
        return {
            ...
            updateAmount() {
                if (this.form.fee_record_id) {
                    ...
                    // Sum of all unpaid fees
                    this.amountPayable = this.fees.reduce((sum, fee) => sum + parseFloat(fee.balance), 0);
                    // Do not auto-fill amount paid for general payment, or maybe auto-fill total?
                    // Let's leave amount_paid as is or empty if it was user input.
                }
            },
